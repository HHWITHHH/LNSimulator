...
directed_edges = preprocess_json_file("%s/firth.json" % data_dir)
...
#Export Datas
output_dir = "output_new1"
if not os.path.exists(output_dir):
	os.makedirs(output_dir)
pd_max_trans.to_csv("%s/max_trans1.csv" % output_dir)
pd_nodes_count.to_csv("%s/nodes_count1.csv" % output_dir)
pd_mean_fee_for_sources.to_csv("%s/mean_fee_for_sources1.csv" % output_dir)
pd_total_top_five_trans.to_csv("%s/total_top_five_trans1.csv" % output_dir)
pd_more_than_100_trans.to_csv("%s/count_more_than_100_trans1.csv" % output_dir)
print("\nExport DONE")
